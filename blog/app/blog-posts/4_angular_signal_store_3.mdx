...
Here is how some of the UI using the pagination store could look like:
...
And to illustrate how this can be used, we are going to create a mock service for querying pokemon data :)
