...
<GithubProject 
  name="Angular Signal Store Examples" 
  url="https://github.com/AndreasRoither/blog-projects/tree/main/angular/src/app/shared/blog/ngrx-store"
  description="Complete examples and feature showcase"
/>
...
<div className="w-full relative mt-12 mb-8 rounded-xl bg-linear-to-r from-green-700 via-lime-600 to-emerald-500 p-1 shadow-xl">
